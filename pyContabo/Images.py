...
class Images:
    ...
    def get(
        ...
        if id:
            resp = self._http.request(
                type="get", url=f"https://api.contabo.com/v1/compute/images/{id}"
            )
    ...
    def create(
        self, name: str, url: str, osType: str, version: str, description: str = None
    ) -> bool:
        ...
        resp = self._http.request(
            type="post", url=f"https://api.contabo.com/v1/compute/images", data=data
        )
    ...
    def statistics(self) -> bool:
        resp = self._http.request(
            type="get", url=f"https://api.contabo.com/v1/compute/images/stats"
        )
