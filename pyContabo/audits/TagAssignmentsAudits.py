    ...
    def get(self, page=None, pageSize=None, orderBy=None, tagId=None, resourceId=None,
        ...
        if resp.status_code == 200:
            ...
            for i in resp.json()["data"]:
                audits.append(TagAssignmentsAuditAudit(i))
            return audits
        else:
            return False
